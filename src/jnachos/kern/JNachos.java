...
public abstract class JNachos {
	...
	private static LinkedList<Integer> processIdList;
	private static int SwapCounter  = 0 ;
	private static OpenFile mSwapFilePtr; 
	public static LinkedList<Integer> fifoListList;
	public static NachosFileSystem nachosFileSystem;

	public static HashMap<Integer,Integer> fifoListMap;
	
	public static HashMap<Integer, NachosProcess> objNachosProcess;

	private static LinkedList<JoinSysCallDetails> mJoinData;
	public static synchronized LinkedList<Integer> getProcessIdList() {
		return processIdList;
	}

	public static synchronized void setProcessIdList(LinkedList<Integer> processIdList) {
		//NachosProcess.processIdList = processIdList;
	}
	...
	public static void initialize(String args[]) {
		...
		processIdList = new LinkedList<Integer>();
		fifoListList = new LinkedList<Integer>();
		fifoListMap = new HashMap<Integer,Integer>();
		objNachosProcess = new HashMap<Integer,NachosProcess>();
		setmJoinData(new LinkedList<JoinSysCallDetails>());  
				//JoinSysCallDetails(mInvokingPid, mWaitingOnPid, objJoinWaitingProcessPtr);
		...
		//mSynchDisk.delete();
		File file = new File("/Users/ankitagadage/Jnachos/Project1 (1)/JNachosProject1/DISK");
		file.delete();
		
		mSynchDisk = new SynchDisk("DISK");
		
		mFileSystem = new JavaFileSystem(format);
		mFileSystem.create("SwapSpace", 0);
		setmSwapFilePtr(mFileSystem.open("SwapSpace"));
	...
	public static LinkedList<JoinSysCallDetails> getmJoinData() {
		return mJoinData;
	}

	public static void setmJoinData(LinkedList<JoinSysCallDetails> mJoinData) {
		JNachos.mJoinData = mJoinData;
	}
	...
	public static void setSwapCounter(int swapCounter) {
		SwapCounter = swapCounter;
	}

	public static OpenFile getmSwapFilePtr() {
		return mSwapFilePtr;
	}

	public static void setmSwapFilePtr(OpenFile mSwapFilePtr) {
		JNachos.mSwapFilePtr = mSwapFilePtr;
	}
